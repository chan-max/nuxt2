    ...
    <main class="container mx-auto px-6 py-10 bg-white shadow-2xl rounded-xl">
      ...
      <section class="mb-10">
        <p class="text-gray-700 text-lg leading-relaxed text-center max-w-4xl mx-auto">
          Welcome to <span class="font-semibold">Craythar</span>! These terms and
          conditions outline the rules and regulations for using Craythar's website. If
          you do not agree to these terms, we kindly ask you to discontinue using this
          website.
        </p>
      </section>
      ...
      <!-- Terminology Section -->
      <section class="mb-8">
        <h2 class="text-3xl font-bold text-gray-800 mb-4">Terminology</h2>
        <p class="text-gray-700 text-lg leading-relaxed">
          The following terminology applies to these Terms and Conditions, Privacy Policy,
          and Disclaimer Notice, as well as all Agreements:
        </p>
        <ul class="list-disc list-inside text-gray-700 mt-4 space-y-2">
          ...
          <li>"The Company," "We," "Our," and "Us" refer to Craythar.</li>
          <li>
            "Party," "Parties," or "Us" refers to both the Client and Craythar
            collectively.
          </li>
        </ul>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          We use cookies to enhance your experience on Craythar. By using our website, you
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Unless otherwise stated, Craythar and its licensors own the intellectual
          property rights for all material on this website. All rights are reserved. The
          following actions are not permitted:
        </p>
        <ul class="list-disc list-inside text-gray-700 mt-4 space-y-2">
          <li>Republishing material from Craythar without explicit permission.</li>
          <li>Selling, renting, or sub-licensing material from Craythar.</li>
          <li>Reproducing, duplicating, or copying material from Craythar.</li>
          <li>Redistributing content from Craythar without explicit permission.</li>
        </ul>
      </section>

      <!-- Hyperlinking Section -->
      <section class="mb-8">
        <h2 class="text-3xl font-bold text-gray-800 mb-4">Hyperlinking to Our Content</h2>
        <p class="text-gray-700 text-lg leading-relaxed">
          ...
          must not falsely imply sponsorship or endorsement by Craythar.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Craythar is not responsible for content appearing on your website. You agree to
          protect and defend us against any claims arising from content on your website.
          Links to Craythar must not promote unlawful activities or infringe on the rights
          of others.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          To the fullest extent permitted by law, Craythar excludes all warranties and is
