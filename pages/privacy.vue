    ...
    <main class="container mx-auto px-6 py-10 bg-white shadow-2xl rounded-xl">
      ...
      <section class="mb-10">
        <p class="text-gray-700 text-lg leading-relaxed text-center max-w-4xl mx-auto">
          ...
          <span class="font-semibold">Cryonix</span>. Depending on your activities while
          visiting Cryonix, you may be required to agree to additional terms of service.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Like most websites, Cryonix collects non-personally-identifying information that
          web browsers and servers typically make available. This includes details like
          browser type, language preference, referring site, and the date and time of each
          visitor request. From time to time, we may use this information in aggregate to
          better understand website usage trends and improve our services.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Certain interactions with Cryonix may require the collection of
          personally-identifying information, such as when you create an account or join a
          team. The type and amount of information collected depend on the nature of the
          interaction, typically including a username, email address, and gameplay
          preferences.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Protecting your personal information is a top priority at Cryonix. While we
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Ads appearing on Cryonix may be served by our advertising partners, who may use
          cookies to collect information. These cookies help deliver targeted
          advertisements that align with your interests and preferences. Please review the
          privacy policies of these advertising partners to understand their practices.
        </p>
      </section>
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Cryonix may include links to external websites that are not operated by us. If
      ...
      <section class="mb-8">
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          Cryonix may collect aggregated, anonymized data about user behavior, such as
          time spent in specific activities or community events. This data is used to
          improve the overall player experience and optimize gameplay features. Aggregated
          data never includes personally-identifying information.
        </p>
      </section>
      ...
      <section>
        ...
        <p class="text-gray-700 text-lg leading-relaxed">
          To personalize your gaming experience, Cryonix uses cookies and similar
